...
TEST(SymbolTable, AddAndLookupCorrect) {
    SymbolTableEntry* entry1 = new SymbolTableEntry("foo",0,0,0,0);
    SymbolTableEntry* entry2 = new SymbolTableEntry("bar",0,0,0,0);
    SymbolTableEntry* entry3 = new SymbolTableEntry("var",0,0,0,0);
